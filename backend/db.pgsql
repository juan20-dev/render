...
INSERT INTO productos (nombre, categoria_id, descripcion, precio, stock, stock_minimo, estado, tipo_producto, imagen_url) VALUES
('Whisky Andino 750ml', 1, 'Whisky suave con notas de roble y vainilla', 68000.00, 24, 6, 'Activo', 'terminado', '/uploads/productos/seed_01.webp'),
('Whisky Reserva Roble 750ml', 1, 'Whisky madurado con perfil intenso y especiado', 82000.00, 18, 5, 'Activo', 'terminado', '/uploads/productos/seed_02.webp'),
('Ron Caribe Dorado 750ml', 2, 'Ron dorado ideal para cocteleria y consumo solo', 42000.00, 32, 8, 'Activo', 'terminado', '/uploads/productos/seed_03.webp'),
('Ron Anejo Gran Barrica 750ml', 2, 'Ron anejo con final largo y aroma tostado', 59000.00, 20, 6, 'Activo', 'terminado', '/uploads/productos/seed_04.webp'),
('Vino Tinto Casa Vieja 750ml', 3, 'Vino tinto afrutado de cuerpo medio', 36000.00, 28, 8, 'Activo', 'terminado', '/uploads/productos/seed_05.webp'),
('Vino Blanco Monteluna 750ml', 3, 'Vino blanco fresco con notas citricas', 34000.00, 22, 6, 'Activo', 'terminado', '/uploads/productos/seed_06.webp'),
('Espumoso Brisa Rosa 750ml', 3, 'Espumoso semidulce para celebraciones', 39000.00, 16, 5, 'Activo', 'terminado', '/uploads/productos/seed_07.webp'),
('Cerveza Rubia Artesanal 330ml', 4, 'Cerveza ligera con amargor balanceado', 6500.00, 72, 18, 'Activo', 'terminado', '/uploads/productos/seed_08.webp'),
('Cerveza Roja Artesanal 330ml', 4, 'Cerveza maltosa con notas caramelizadas', 6900.00, 65, 15, 'Activo', 'terminado', '/uploads/productos/seed_09.webp'),
('Cerveza Negra Porter 330ml', 4, 'Cerveza oscura con notas a cacao y cafe', 7200.00, 54, 14, 'Activo', 'terminado', '/uploads/productos/seed_10.webp'),
('Tequila Agave Azul 750ml', 5, 'Tequila joven 100 por ciento agave', 76000.00, 14, 4, 'Activo', 'terminado', '/uploads/productos/seed_11.webp'),
('Tequila Reposado Sierra 750ml', 5, 'Tequila reposado con notas de miel y madera', 89000.00, 12, 4, 'Activo', 'terminado', '/uploads/productos/seed_12.webp'),
('Vodka Cristal 700ml', 6, 'Vodka clasico de perfil limpio y neutro', 47000.00, 26, 7, 'Activo', 'terminado', '/uploads/productos/seed_13.webp'),
('Vodka Citrus 700ml', 6, 'Vodka saborizado con limon y cascara de naranja', 49000.00, 19, 5, 'Activo', 'terminado', '/uploads/productos/seed_14.webp'),
('Crema de Cafe 700ml', 7, 'Licor cremoso con notas intensas de cafe', 41000.00, 18, 5, 'Activo', 'terminado', '/uploads/productos/seed_15.webp'),
('Crema de Coco 700ml', 7, 'Licor cremoso de coco para postres y cocteles', 43000.00, 17, 5, 'Activo', 'terminado', '/uploads/productos/seed_16.webp'),
('Ginebra Botanica 750ml', 8, 'Ginebra artesanal con botanicos colombianos', 78000.00, 15, 4, 'Activo', 'terminado', '/uploads/productos/seed_17.webp'),
('Ginebra Limonaria 750ml', 8, 'Ginebra citrica con final herbal', 80000.00, 13, 4, 'Activo', 'terminado', '/uploads/productos/seed_18.webp'),
('Aguardiente Tradicion 750ml', 9, 'Aguardiente clasico anisado de venta continua', 33000.00, 40, 10, 'Activo', 'terminado', '/uploads/productos/seed_19.webp'),
('Aguardiente Sin Azucar 750ml', 9, 'Aguardiente suave sin azucar adicionada', 35000.00, 34, 8, 'Activo', 'terminado', '/uploads/productos/seed_20.webp'),

('Base de Limoncello', 11, 'Preparacion macerada de limon para embotellado', 22000.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_21.webp'),
('Base de Crema Irlandesa', 11, 'Preparacion cremosa para licor estilo irlandes', 28000.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_22.webp'),
('Macerado de Frutos Rojos', 11, 'Base macerada de frutos rojos para licor', 24000.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_23.webp'),
('Macerado de Cafe', 11, 'Preparacion de cafe para licor artesanal', 23000.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_24.webp'),
('Preparacion Pina Colada', 11, 'Base de pina y coco para cocteleria lista', 26000.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_25.webp'),
('Preparacion Mojito Artesanal', 11, 'Preparacion con hierbabuena y limon', 21000.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_26.webp'),
('Preparacion Maracuya', 11, 'Base tropical para licor frutal', 22500.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_27.webp'),
('Preparacion Naranja Especiada', 11, 'Macerado citrico con clavo y canela', 21500.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_28.webp'),
('Preparacion Hierbabuena', 11, 'Base herbal para bebidas refrescantes', 20500.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_29.webp'),
('Preparacion Canelazo', 11, 'Base especiada para licor caliente', 23500.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_30.webp'),
('Preparacion Crema de Whisky', 11, 'Base cremosa para licor de whisky', 29500.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_31.webp'),
('Preparacion Licor de Coco', 11, 'Preparacion dulce de coco para embotellar', 25500.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_32.webp'),
('Preparacion Tamarindo', 11, 'Base concentrada de tamarindo', 22500.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_33.webp'),
('Preparacion Jamaica', 11, 'Macerado de flor de jamaica', 21800.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_34.webp'),
('Preparacion Frambuesa', 11, 'Base de frambuesa para licor artesanal', 24800.00, 0, 0, 'Activo', 'preparacion', '/uploads/productos/seed_35.webp'),

('Alcohol Etilico Food Grade', 12, 'Alcohol base para elaboracion de licores artesanales', 95000.00, 60, 15, 'Activo', 'insumo', '/uploads/productos/seed_36.webp'),
('Azucar Refinada x 25kg', 12, 'Azucar refinada para preparaciones y jarabes', 82000.00, 48, 12, 'Activo', 'insumo', '/uploads/productos/seed_37.webp'),
('Botella Transparente 750ml', 12, 'Botella de vidrio para productos terminados', 4200.00, 220, 60, 'Activo', 'insumo', '/uploads/productos/seed_38.webp'),
('Tapa Rosca Dorada', 12, 'Tapa metalica de seguridad para botella 750ml', 450.00, 500, 120, 'Activo', 'insumo', '/uploads/productos/seed_39.webp'),
('Etiqueta Premium', 12, 'Etiqueta adhesiva resistente a humedad', 380.00, 480, 120, 'Activo', 'insumo', '/uploads/productos/seed_40.webp'),
('Esencia de Vainilla x 1L', 12, 'Esencia concentrada para perfiles dulces y cremosos', 36000.00, 26, 8, 'Activo', 'insumo', '/uploads/productos/seed_41.webp'),
('Pulpa de Mora x 5kg', 12, 'Pulpa congelada para macerados de fruta', 54000.00, 18, 6, 'Activo', 'insumo', '/uploads/productos/seed_42.webp'),
('Pulpa de Maracuya x 5kg', 12, 'Pulpa tropical para preparaciones frutales', 56000.00, 16, 6, 'Activo', 'insumo', '/uploads/productos/seed_43.webp'),
('Jarabe Simple x 5L', 12, 'Jarabe base para cocteleria y mezclas', 29000.00, 22, 7, 'Activo', 'insumo', '/uploads/productos/seed_44.webp'),
('Glicerina Alimentaria x 1L', 12, 'Glicerina para ajustar textura en cremas licorosas', 31000.00, 14, 5, 'Activo', 'insumo', '/uploads/productos/seed_45.webp');
