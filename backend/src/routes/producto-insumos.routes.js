...
router.post('/', authorizePermissions('Crear Producto-Insumos'), validate(createInsumoBody), controller.create);
router.put('/:id', authorizePermissions('Editar Producto-Insumos'), validate(idParam, 'params'), validate(updateInsumoBody), controller.update);
